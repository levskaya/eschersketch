...
(function() {
  var CANVAS_HEIGHT, CANVAS_WIDTH, DRAW_interval, Drawing, MAX_linewidth, MIN_linewidth, PI, abs, acos, affineset, asin, atan, canvas, changeLineWidth, changeOpacity, circlepaint, clearScreen, coordsToAngle, cos, ctx, drawLine, floor, gridDraw, gridcanvas, gridctx, initGUI, keyState, lastline, lattice, map, max, min, onCanvasMousedown, onCenterMousedown, onDocumentKeydown, onDocumentKeyup, onDocumentMousemove, onDocumentMouseup, onGridMouseMove, onGridMouseUp, onRotScaleMousedown, pow, renderPoint, root, round, saveImage, setColor, sign, sin, sketch, sqrt, tan, toggleGrid, uiState, updateLattice, updateTiling;
  ...
  initGUI = function() {
    ...
    return $('#showgrid').click(toggleGrid);
  };

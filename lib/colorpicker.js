...
(function(window, document, undefined) {
    ...
    var type = "SVG", //(window.SVGAngle || document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") ? "SVG" : "VML"),
    ...
    function ColorPicker(slideElement, pickerElement, callback) {
	    ...
	    // XXX: getElementById doesn't work in some Safari versions in SVG !!

            var hsvGradient = slideClone.children[0].children[0];
	    //var hsvGradient = slideClone.getElementById('gradient-hsv');
            ...
            var blackAndWhiteGradients = [pickerClone.children[0].children[0], pickerClone.children[0].children[1]];
